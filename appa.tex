...
I passi per compilare, eseguire e correggere il codice dipendono dal tuo ambiente di sviluppo e dal tuo sistema operativo.
Abbiamo evitato di scrivere questi dettagli nel testo principale perchè possono distrarre.
Invece in questa appendice forniamo una breve tead, we provide this appendix with a brief introduction to DrJava---an {\bf integrated development environment} (IDE) that is helpful for beginners---and other development tools, including Checkstyle for code quality and JUnit for testing.
